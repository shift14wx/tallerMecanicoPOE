<template>
    <div>
        <h2 id="page-heading">
            <span v-text="$t('tallerMecanicoPoeApp.rol.home.title')" id="rol-heading">Rols</span>
            <router-link :to="{name: 'RolCreate'}" tag="button" id="jh-create-entity" class="btn btn-primary float-right jh-create-entity create-rol">
                ...
                <span  v-text="$t('tallerMecanicoPoeApp.rol.home.createLabel')">
                    Create a new Rol
                </span>
            </router-link>
        </h2>
        ...
        <div class="alert alert-warning" v-if="!isFetching && rols && rols.length === 0">
            <span v-text="$t('tallerMecanicoPoeApp.rol.home.notFound')">No rols found</span>
        </div>
        <div class="table-responsive" v-if="rols && rols.length > 0">
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <th><span v-text="$t('tallerMecanicoPoeApp.rol.rol')">Rol</span></th>
                    <th></th>
                </tr>
                </thead>
                <tbody>
        ...
        <b-modal ref="removeEntity" id="removeEntity" >
            <span slot="modal-title"><span id="tallerMecanicoPoeApp.rol.delete.question" v-text="$t('entity.delete.title')">Confirm delete operation</span></span>
            <div class="modal-body">
                <p id="jhi-delete-rol-heading" v-text="$t('tallerMecanicoPoeApp.rol.delete.question', {'id': removeId})">Are you sure you want to delete this Rol?</p>
            </div>
