...
describe('Service Tests', () => {
  describe('Entrada Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Entrada(0, 'AAAAAAA', false, 0);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should not create a Entrada', async () => {
      ...
      it('should not update a Entrada', async () => {
      ...
      it('should not return a list of Entrada', async () => {
        mockedAxios.get.mockReturnValue(Promise.reject(error));
      ...
      it('should not delete a Entrada', async () => {
